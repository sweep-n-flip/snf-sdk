...
/**
 * Provider resolution — merges a partner's own `config.providers`
 ...
 * surface reachable with no API key on every one of the 14 chains (Free
 ...
 * (`inventory/poolInventory.ts`) and a provider override is optional there
 ...
 * the true state is "no provider was configured to ask." this rule's own words: "the
 ...
 * sharing it across clients on different chains violates nothing this package's own
 * isolation rules protect). */
